    ...
    <div className="min-h-screen flex flex-col" style={{ background: "var(--rb-base)" }}>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-md">
          ...
          {/* Auth card */}
          <div className="p-8" style={{ background: "var(--rb-container)", border: "1px solid rgba(255,181,156,0.08)" }}>
            ...
            <div className="flex flex-col gap-3 mb-6">
              <button style={{
                ...
                border: "1px solid rgba(255,181,156,0.12)", cursor: "pointer", width: "100%",
            ...
            <div className="flex items-center gap-3 mb-6">
              <div style={{ flex: 1, height: 1, background: "rgba(255,181,156,0.1)" }} />
